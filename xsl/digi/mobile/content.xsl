...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!-- 处理分支 <xsl:value-of select="$selectFlows" />-->
	<!--<xsl:variable name="selectFlows"><xsl:value-of select="//div[@name='Fck_HTML']//fieldentry[@id='NextPsn']/value/text/."/></xsl:variable>-->
	

	<xsl:if test="contains(@id, 'NextPsn')">
		<select id="NextPsn" name="NextPsn" onChange='' data-theme="c" >
